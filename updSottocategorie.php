...
$getCategoria = sys3db::db()->prepare("SELECT * FROM sottocategorie WHERE id ='$categoriaid'");

$sql = sys3db::db()->prepare("UPDATE `sottocategorie` SET categoriaParent=:categoriaparent, Titolo=:titolo WHERE id='$categoriaid'");
