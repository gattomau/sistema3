      ...
      <h1>Cestino Iscritti</h1>
        ...
        <table id="userTable" class="table">
          <tr>
            ...
            <td><span style="font-weight: bold"></span></td>
            <td><span style="font-weight: bold"></span></td>
            <td colspan="2"><span style="font-weight: bold"><input id="inputCercaNome" onkeyup="myFunction()" type="text" name="" value="" placeholder="Nome"></span></td>
            <td colspan="2"><span style="font-weight: bold"><input id="inputCercaCognome" onkeyup="hisFunction()" type="text" name="" value="" placeholder="Cognome"></span></td>
        ...
        <?php foreach($iscritti->recuperarem() as $sub): ?>
          <tr>
