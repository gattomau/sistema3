...
$sql = sys3db::db()->prepare('INSERT INTO `sottocategorie` (categoriaParent, Titolo) VALUES (:categoriaparent, :titolo);');

$sql->bindParam(':categoriaparent', $categoriaparent);
$sql->bindParam(':titolo', $titolo);

$categoriaparent = (!empty($_POST['categoriaparent'])) ? $_POST['categoriaparent'] : 0;
...
<html style="min-height: 100%; min-width: 100%">
  ...
  <body style="background-color: #222d32; position: absolute; min-height: 100%; max-height: 100%; height: 100%; width: 100%; position: absolute">
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="categoriaparent">
